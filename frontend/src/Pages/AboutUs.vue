<template>
    ...
    <!-- Banner Section -->
    <section
      class="relative bg-cover bg-top h-[300px] flex items-center px-6 md:px-16"
      style="background-image: url('/about-us-banner.png');"
    >
...
<section class="px-8 py-12">
  ...
  <div class="text-center mb-10">
    ...
    <p class="text-gray-600 mt-2 text-sm sm:text-base max-w-3xl mx-auto">
      This approach involves a direct relationship between the pediatrician and the patient and may include additional services and
    </p>
  </div>
...
<section class="px-8 py-12">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-8 gap-x-4">
    ...
    <div class="flex items-center space-x-3">
      <div class="bg-[#2077BF] text-white rounded-full w-10 h-10 flex justify-center items-center">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 2v9.586a2 2 0 0 1-.586 1.414l-3.828 3.828a4 4 0 1 0 5.656 5.656l3.828-3.828A2 2 0 0 1 15.586 17H21" />
        </svg>
      </div>
    ...
    <div class="flex items-center space-x-3">
      <div class="bg-[#2077BF] text-white rounded-full w-10 h-10 flex justify-center items-center">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 9.75L12 3l9 6.75M4.5 10.5V21h15V10.5" />
        </svg>
      </div>
    ...
    <div class="flex items-center space-x-3">
      <div class="bg-[#2077BF] text-white rounded-full w-10 h-10 flex justify-center items-center">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M6 9V2h12v7M6 18h12v4H6v-4zM4 9h16a2 2 0 012 2v5H2v-5a2 2 0 012-2z" />
        </svg>
      </div>
    ...
    <div class="flex items-center space-x-3">
      <div class="bg-[#2077BF] text-white rounded-full w-10 h-10 flex justify-center items-center">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 4h10M7 8h10M7 12h6a4 4 0 1 1 0 8H7" />
        </svg>
      </div>
    ...
    <div class="flex items-center space-x-3">
      <div class="bg-[#2077BF] text-white rounded-full w-10 h-10 flex justify-center items-center">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 5l-14 14M8.5 8.5a2 2 0 1 1-2.828-2.828A2 2 0 0 1 8.5 8.5zm9 9a2 2 0 1 1-2.828-2.828A2 2 0 0 1 17.5 17.5z" />
        </svg>
      </div>
  ...
  <section
  class="relative bg-cover bg-center bg-no-repeat text-white py-8 px-6"
  style="background-image: url('/working-lab.jpg');"
>
  <!-- Overlay -->
